...
const contactInfo = [
  ...
  },
  {
    icon: Mail,
    label: 'Email',
    value: 'subodh.ram@example.com',
    href: 'mailto:subodh.ram@example.com',
    protocol: 'SMTP'
  },
  {
    icon: SiLinkedin,
  ...
  },
  {
    icon: Github,
    label: 'GitHub',
    value: 'github.com/subodhram',
    href: 'https://github.com/subodhram',
    protocol: 'HTTPS'
  }
];
      ...
      <div className="max-w-6xl mx-auto">
        <div className="mb-8">
          <div className="flex items-center gap-2 mb-4">
            ...
            <span className="text-terminal-white font-mono">ping contacts -t</span>
          </div>
        ...
        <div className="terminal-box p-6 mb-6">
          <div className="font-mono text-terminal-white text-sm mb-6">
            <div className="text-terminal-yellow mb-2">Pinging contact endpoints...</div>
          ...
          <div className="font-mono text-xs mb-4 overflow-x-auto">
            <div className="grid grid-cols-[100px_150px_1fr_80px] gap-4 pb-2 border-b border-terminal-green/30 min-w-[600px]">
              ...
              <div className="text-terminal-yellow">Endpoint</div>
              ...
              return (
                ...
                >
                  <div className="font-mono text-xs grid grid-cols-1 sm:grid-cols-[100px_150px_1fr_80px] gap-2 sm:gap-4 items-center min-w-[600px] sm:min-w-0">
                    ...
                    <div className="text-terminal-gray break-all">{contact.value}</div>
